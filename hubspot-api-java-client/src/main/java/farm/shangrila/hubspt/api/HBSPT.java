...
import farm.shangrila.hbspt.api.model.*;
...
public class HBSPT extends AbstractGoogleJsonClient {
    ...
    public class Owners {
        ...
        public class Get extends HBSPTRequest<Owners[]> {

            private static final String REST_PATH = "owners/v2/owners/";

            protected Get() {
                super(HBSPT.this, "GET", REST_PATH, null, Owners[].class);
            }
    ...
    public class Calendars {
        ...
        public Insert insert(Calendars content) throws java.io.IOException {
            Insert result = new Insert(content);
            initialize(result);
            return result;
        }

        public class Insert extends HBSPTRequest<Calendars> {

            private static final String REST_PATH = "calendar/v1/events/task";

            protected Insert(Calendars content) {
                super(HBSPT.this, "POST", REST_PATH, content, Calendars.class);
            }
    ...
    public class Contacts {
        ...
        public class List extends HBSPTRequest<ContactsListResponse> {

            private static final String REST_PATH = "contacts/v1/lists/all/contacts/all";

            protected List() {
                super(HBSPT.this, "GET", REST_PATH, null, ContactsListResponse.class);
            }
        }
    }
    ...
    public class ContactsList {
        ...
        public GetContacts contacts(String listId) throws java.io.IOException {
            GetContacts result = new GetContacts(listId);
            initialize(result);
            return result;
        }
    ...
    public class Deals {
        ...
        public Update update(String dealId, DealsUpdate content) throws java.io.IOException {
            Update result = new Update(dealId, content);
            initialize(result);
            return result;
        }

        public class Update extends HBSPTRequest<DealsResponse> {
            ...
            protected Update(String dealId, DealsUpdate content) {
                super(HBSPT.this, "PUT", REST_PATH, content, DealsResponse.class);
        ...
        public Insert insert(Deals content) throws java.io.IOException {
            Insert result = new Insert(content);
            initialize(result);
            return result;
        }

        public class Insert extends HBSPTRequest<DealsResponse> {

            private static final String REST_PATH = "deals/v1/deal";

            protected Insert(Deals content) {
                super(HBSPT.this, "POST", REST_PATH, content, DealsResponse.class);
            }
        ...
        public class Get extends HBSPTRequest<DealsResponse> {
            ...
            protected Get(String dealId) {
                super(HBSPT.this, "GET", REST_PATH, null, DealsResponse.class);
                this.dealId = ((String) Preconditions.checkNotNull(dealId,
